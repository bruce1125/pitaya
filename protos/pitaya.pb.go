...
const (
	...
	Pitaya_SessionClosed_FullMethodName     = "/protos.Pitaya/SessionClosed"
)
...
type PitayaClient interface {
	...
	SessionClosed(ctx context.Context, in *CloseMsg, opts ...grpc.CallOption) (*CloseAnswer, error)
}
...
func (c *pitayaClient) SessionClosed(ctx context.Context, in *CloseMsg, opts ...grpc.CallOption) (*CloseAnswer, error) {
	out := new(CloseAnswer)
	err := c.cc.Invoke(ctx, Pitaya_SessionClosed_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PitayaServer interface {
	...
	SessionClosed(context.Context, *CloseMsg) (*CloseAnswer, error)
}
...
func (UnimplementedPitayaServer) SessionClosed(context.Context, *CloseMsg) (*CloseAnswer, error) {
...
func _Pitaya_SessionClosed_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CloseMsg)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PitayaServer).SessionClosed(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Pitaya_SessionClosed_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PitayaServer).SessionClosed(ctx, req.(*CloseMsg))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Pitaya_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Pitaya_SessionClosed_Handler,
		},
	},

...
// SessionClosed mocks base method.
func (m *MockPitayaClient) SessionClosed(ctx context.Context, in *protos.CloseMsg, opts ...grpc.CallOption) (*protos.CloseAnswer, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "SessionClosed", varargs...)
	ret0, _ := ret[0].(*protos.CloseAnswer)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// SessionClosed indicates an expected call of SessionClosed.
func (mr *MockPitayaClientMockRecorder) SessionClosed(ctx, in interface{}, opts ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx, in}, opts...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SessionClosed", reflect.TypeOf((*MockPitayaClient)(nil).SessionClosed), varargs...)
}
...
// SessionClosed mocks base method.
func (m *MockPitayaServer) SessionClosed(arg0 context.Context, arg1 *protos.CloseMsg) (*protos.CloseAnswer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SessionClosed", arg0, arg1)
	ret0, _ := ret[0].(*protos.CloseAnswer)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
// SessionClosed indicates an expected call of SessionClosed.
func (mr *MockPitayaServerMockRecorder) SessionClosed(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SessionClosed", reflect.TypeOf((*MockPitayaServer)(nil).SessionClosed), arg0, arg1)
}

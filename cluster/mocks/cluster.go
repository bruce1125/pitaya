...
// BroadcastSessionClosed mocks base method.
func (m *MockRPCClient) BroadcastSessionClosed(uid string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "BroadcastSessionClosed", uid)
	ret0, _ := ret[0].(error)
	return ret0
}

// BroadcastSessionClosed indicates an expected call of BroadcastSessionClosed.
func (mr *MockRPCClientMockRecorder) BroadcastSessionClosed(uid interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "BroadcastSessionClosed", reflect.TypeOf((*MockRPCClient)(nil).BroadcastSessionClosed), uid)
}
...
// MockRemoteClosedListener is a mock of RemoteClosedListener interface.
type MockRemoteClosedListener struct {
	ctrl     *gomock.Controller
	recorder *MockRemoteClosedListenerMockRecorder
}

// MockRemoteClosedListenerMockRecorder is the mock recorder for MockRemoteClosedListener.
type MockRemoteClosedListenerMockRecorder struct {
	mock *MockRemoteClosedListener
}

// NewMockRemoteClosedListener creates a new mock instance.
func NewMockRemoteClosedListener(ctrl *gomock.Controller) *MockRemoteClosedListener {
	mock := &MockRemoteClosedListener{ctrl: ctrl}
	mock.recorder = &MockRemoteClosedListenerMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockRemoteClosedListener) EXPECT() *MockRemoteClosedListenerMockRecorder {
	return m.recorder
}

// OnFrontendSessionClosed mocks base method.
func (m *MockRemoteClosedListener) OnFrontendSessionClosed(uid string) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "OnFrontendSessionClosed", uid)
}

// OnFrontendSessionClosed indicates an expected call of OnFrontendSessionClosed.
func (mr *MockRemoteClosedListenerMockRecorder) OnFrontendSessionClosed(uid interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "OnFrontendSessionClosed", reflect.TypeOf((*MockRemoteClosedListener)(nil).OnFrontendSessionClosed), uid)
}
